...
main (int argc, char *argv[])
{
  ...
  //  LogComponentEnable ("PointToPointChannel", LogLevel (LOG_LEVEL_ALL|LOG_PREFIX_TIME|LOG_PREFIX_NODE));
      LogComponentEnable ("PointToPointNetDevice", LogLevel (LOG_LEVEL_ALL|LOG_PREFIX_TIME|LOG_PREFIX_NODE));
